...
namespace Apresentacao.Views
{
    ...
    public partial class ContactsPage : ContentPage
    {
        ...
        public ContactsPage()
        {
            ...
            {
                _contacts.Add((Contact)Application.Current.Properties["1"]);
            }
            else
            {
                _contacts.Add(new Contact { Id = 1, FirstName = "John", LastName = "Smith", Email = "john@smith.com", Phone = "1111" });
            }

            if (Application.Current.Properties.ContainsKey("2"))
            {
                _contacts.Add((Contact)Application.Current.Properties["2"]);
            }
            else
            {
                _contacts.Add(new Contact { Id = 2, FirstName = "Mary", LastName = "Johnson", Email = "mary@johnson.com", Phone = "2222" });
            }  
